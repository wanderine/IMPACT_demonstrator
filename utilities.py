...
def load_T1GDT1T2FLAIRT2(data_directory='', nr_to_load=0):
    ...
    print('Max T1GD image value before processing is ', np.max(images))
...
def load_qMRI(data_directory='', nr_to_load=0):
    ...
    print('Max qMRI T1 image value before processing is ', np.max(images))
    ...
    print('Max qMRI T2 image value before processing is ', np.max(images))
    ...
    print('Max qMRI PD image value before processing is ', np.max(images))
...
def load_qMRI_GD(data_directory='', nr_to_load=0):
    ...
    print('Max qMRI T1 GD image value before processing is ', np.max(images))
    ...
    print('Max qMRI T2 GD image value before processing is ', np.max(images))
    ...
    print('Max qMRI PD GD image value before processing is ', np.max(images))
